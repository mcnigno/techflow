...
class Discipline(NestedSet):
	nsm_parent_field = 'parent_discipline'
...
def set_multiple_status(names, status):
	...
	for name in names:
		discipline = frappe.get_doc("Discipline", name)
...
def add_node():
	...
	if args.parent_discipline == 'All Disciplines' or args.parent_discipline == args.project:
		args.parent_discipline = None

	frappe.get_doc(args).insert()

@frappe.whitelist()
def add_multiple_disciplines(data, parent):
	data = json.loads(data)
	new_doc = {'doctype': 'Discipline', 'parent_discipline': parent if parent!="All Disciplines" else ""}
	new_doc['project'] = frappe.db.get_value('Discipline', {"name": parent}, 'project') or ""
